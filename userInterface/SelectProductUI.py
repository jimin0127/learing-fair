...
class ProductItem(QWidget):
    ...
    def unit_ui(self):
        ...
        pixmap = QPixmap(get_resource_path(self.product["image_path"])).scaled(120, 120, Qt.KeepAspectRatio)
        image_label = QLabel()
        ...
        price_label = QLabel(format_price(self.product['price']))
        ...
        buy_btn.clicked.connect(lambda: self.open_product_detail(self.product))
...
class SelectProductUI(QWidget):
    ...
    def unit_ui(self):
        products = self.product_service.find_all_by_category(self.selected_category)
        ...
        category_label = QLabel(self.selected_category)
        ...
        for index, product in enumerate(products):
            ...
            item = ProductItem(product, self.open_product_detail)
